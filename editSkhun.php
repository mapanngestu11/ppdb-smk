...
{
    unlink("skhun/".$skhunDulu); //hapus file sebelumnya
    $skhun=$_FILES['skhun'] ['name'];   
    $lokasiSkhun=$_FILES['skhun'] ['tmp_name'];
    $lokasiTujuanSkhun="./skhun";  
    $upload=move_uploaded_file($lokasiSkhun,$lokasiTujuanSkhun."/".$skhun); 
    // update user data
    $result = mysqli_query($conn, "UPDATE datasiswa SET skhun='$skhun' WHERE nisn='$nisn'");
...
<!-- Code MENU -->
    ...
    <div class="content-wrapper">
        <div class="container" id="wadah">
            <div class="row">
        <div class="col-md-12">
            <h4><font color="#3498db">Edit Foto 
            </font></h4>
        </div>
    </div>
    <div class="row">
