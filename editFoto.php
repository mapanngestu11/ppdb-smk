...
{
    unlink("foto/".$fotoDulu); //hapus file sebelumnya
    $foto = $_FILES['foto'] ['name'];   
    $lokasiFoto = $_FILES['foto'] ['tmp_name'];
    $lokasiTujuanFoto="./foto";  
    $uploadFoto=move_uploaded_file($lokasiFoto,$lokasiTujuanFoto."/".$foto);
    // update user data
    $result = mysqli_query($conn, "UPDATE datasiswa SET foto='$foto' WHERE nisn='$nisn'");
        ...
        <div class="col-md-12">
            <form method="post" enctype="multipart/form-data" action="">
                <div class="form-group">
                    ...
                    <input type="file" class="form-control-file" id="foto" name="foto" accept="">
                </div>
