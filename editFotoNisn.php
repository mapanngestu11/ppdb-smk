...
$fotoNisnDulu = $datasiswa['fotoNisn']; 

//jika tombol ditekan
if(isset($_POST['update']))
{
    unlink("fotoNisn/".$fotoNisnDulu); //hapus file sebelumnya
    ...
    // update user data
    $result = mysqli_query($conn, "UPDATE datasiswa SET fotoNisn='$fotoNisn' WHERE nisn='$nisn'");
...
<!-- Code MENU -->
    ...
    <div class="content-wrapper">
        <div class="container" id="wadah">
            <div class="row">
        <div class="col-md-12">
            <h4><font color="#3498db">Edit Foto NISN
            </font></h4>
        </div>
    </div>
    <div class="row">
