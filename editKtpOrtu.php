...
$fotoktpOrtu = $datasiswa['ktpOrtu']; 

//jika tombol ditekan
if(isset($_POST['update']))
{
    unlink("ktpOrtu/".$fotoktpOrtu); //hapus file sebelumnya
    $ktpOrtu=$_FILES['ktpOrtu'] ['name'];   
    $lokasiktpOrtu=$_FILES['ktpOrtu'] ['tmp_name'];
    $lokasiTujuanktpOrtu="./ktpOrtu";  
    $uploadktpOrtu=move_uploaded_file($lokasiktpOrtu,$lokasiTujuanktpOrtu."/".$fotoNisn); 
    // update user data
    $result = mysqli_query($conn, "UPDATE datasiswa SET ktpOrtu='$ktpOrtu' WHERE nisn='$nisn'");
...
<!-- Code MENU -->
    ...
    <div class="content-wrapper">
        <div class="container" id="wadah">
            <div class="row">
        <div class="col-md-12">
            <h4><font color="#3498db">Edit Foto KTP Ortu
            </font></h4>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <form method="post" enctype="multipart/form-data" action="">
                <div class="form-group">
                    <label for="ktpOrtu">Foto KTP Ortu</label>
